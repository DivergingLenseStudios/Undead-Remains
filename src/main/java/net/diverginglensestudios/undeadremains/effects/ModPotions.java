...
public class ModPotions {
	...
	public static final RegistryObject<Potion> ANCHORED_POTION = POTIONS.register("anchored_potion",
			() -> new Potion(new MobEffectInstance(ModEffects.ANCHORED.get(), 200, 0)));
