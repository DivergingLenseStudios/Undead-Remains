...
import net.diverginglensestudios.undeadremains.effects.custom.AnchoredEffect;
...
public class ModEffects {
        public static final DeferredRegister<MobEffect> MOB_EFFECTS = DeferredRegister
                        .create(ForgeRegistries.MOB_EFFECTS, UndeadRemains.MOD_ID);

        public static final RegistryObject<MobEffect> FOSSILIZED_HEART = MOB_EFFECTS.register("fossilized_heart",
                        () -> new FossilizedHeartEffect(MobEffectCategory.HARMFUL, 885910));

        public static final RegistryObject<MobEffect> FOSSIL_VISION = MOB_EFFECTS.register("fossil_vision",
                        () -> new FossilVisionEffect(MobEffectCategory.BENEFICIAL, 925800));

        public static final RegistryObject<MobEffect> ANCHORED = MOB_EFFECTS.register("anchored",
                        () -> new AnchoredEffect(MobEffectCategory.HARMFUL, 821186));
