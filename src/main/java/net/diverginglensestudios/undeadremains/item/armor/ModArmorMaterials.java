...
public enum ModArmorMaterials implements ArmorMaterial {
            FOSSIL("fossil", /*durability multiplier*/26,/*armor values for all pieces*/ new int[]{/*helmet*/(int) 1.5f,/*chestplate*/(int) 5.5f, (int) 4.5f, 2},/*enchantment value*/ 25,
            /*equip sound*/SoundEvents.ARMOR_EQUIP_GENERIC, /*toughness*/0, /*knockback res*/0f,/*🤷‍♂️*/ () -> Ingredient.of(ModItems.FOSSIL.get())),
