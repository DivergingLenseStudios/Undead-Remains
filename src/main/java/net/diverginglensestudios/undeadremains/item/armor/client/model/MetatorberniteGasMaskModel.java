...
public class MetatorberniteGasMaskModel extends ArmorModel { 

	public MetatorberniteGasMaskModel(ModelPart root) {
		super(root);
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mask = armorHead.addOrReplaceChild("mask", CubeListBuilder.create().texOffs(0, 32).addBox(-2.0F, 1.0F, -3.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-4.0F, -4.0F, 0.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.55F))
		.texOffs(0, 16).addBox(-4.0F, -4.0F, 0.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.8F)), PartPose.offset(0.0F, -4.0F, -4.0F));

		PartDefinition player_head_r1 = mask.addOrReplaceChild("player_head_r1", CubeListBuilder.create().texOffs(32, 0).mirror().addBox(0.0F, 0.5F, -6.25F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 1.0F, 3.25F, 0.0F, -0.3927F, 0.0F));

		PartDefinition player_head_r2 = mask.addOrReplaceChild("player_head_r2", CubeListBuilder.create().texOffs(32, 0).addBox(-3.0F, 0.5F, -6.25F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 3.25F, 0.0F, 0.3927F, 0.0F));
