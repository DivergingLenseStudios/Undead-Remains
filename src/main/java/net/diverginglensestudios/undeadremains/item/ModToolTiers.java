...
public static final Tier METATORBERNITE = TierSortingRegistry.registerTier(
        new ForgeTier(3, 1200, 6f, 3f, 25,
                ModTags.Blocks.NEEDS_METATORBERNITE_TOOL, () -> Ingredient.of(ModItems.METATORBERNITE.get())),
...
public static final Tier LANGRITE = TierSortingRegistry.registerTier(
        new ForgeTier(4, 1750, 0f, 0, 13,
                ModTags.Blocks.NEEDS_LANGRITE_TOOL, () -> Ingredient.of(ModItems.LANGRITE_INGOT.get())),
...
public static final Tier RABBIT_FOOT_MODIFIED_FOSSIL = TierSortingRegistry.registerTier(
        new ForgeTier(2, 550, 4.5f, 0, 10,
                ModTags.Blocks.NEEDS_RABBIT_FOOT_MODIFIED_FOSSIL_TOOL, () -> Ingredient.of(Items.RABBIT_FOOT)),
        new ResourceLocation(UndeadRemains.MOD_ID, "rabbit_foot_modified_fossil"), List.of(Tiers.STONE), List.of());
public static final Tier BLAZE_ROD_MODIFIED_FOSSIL = TierSortingRegistry.registerTier(
        new ForgeTier(2, 550, 4.5f, 0, 10,
                ModTags.Blocks.NEEDS_BLAZE_ROD_MODIFIED_FOSSIL_TOOL, () -> Ingredient.of(Items.BLAZE_ROD)),
        new ResourceLocation(UndeadRemains.MOD_ID, "blaze_rod_modified_fossil"), List.of(Tiers.IRON), List.of());
public static final Tier NAUTILUS_SHELL_MODIFIED_FOSSIL = TierSortingRegistry.registerTier(
        new ForgeTier(2, 550, 4.5f, 0, 10,
                ModTags.Blocks.NEEDS_NAUTILUS_SHELL_MODIFIED_FOSSIL_TOOL, () -> Ingredient.of(Items.NAUTILUS_SHELL)),
        new ResourceLocation(UndeadRemains.MOD_ID, "nautilus_shell_modified_fossil"), List.of(Tiers.STONE), List.of());
public static final Tier SLIME_BALL_MODIFIED_FOSSIL = TierSortingRegistry.registerTier(
        new ForgeTier(2, 550, 4.5f, 0, 10,
                ModTags.Blocks.NEEDS_SLIME_BALL_MODIFIED_FOSSIL_TOOL, () -> Ingredient.of(Items.SLIME_BALL)),
        new ResourceLocation(UndeadRemains.MOD_ID, "slime_ball_modified_fossil"), List.of(Tiers.STONE), List.of());
