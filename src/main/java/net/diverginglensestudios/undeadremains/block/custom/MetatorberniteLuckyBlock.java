        ...
        if (pLevel instanceof ServerLevel serverLevel) {
            ...
            if (choice == 1) {////////// EVENT_1//////////
                ...
                switch (toolChoice) {
                    ...
                    case 1 -> toolDrop = new ItemStack(ModItems.METATORBERNITE_TOOL.get());
                ...
                serverLevel.levelEvent(2001, pPos,
                        Block.getId(ModBlocks.METATORBERNITE_BLOCK.get().defaultBlockState())); // Particle effect
