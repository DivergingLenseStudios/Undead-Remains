...
public static final DeferredRegister<Block> BLOCKS =
        DeferredRegister.create(ForgeRegistries.BLOCKS, UndeadRemains.MOD_ID);
...
public static final RegistryObject<Block> SUPREME_BRICKS = registerBlock("supreme_bricks",
        () -> new Block(BlockBehaviour.Properties.copy(Blocks.REINFORCED_DEEPSLATE).sound(SoundType.STONE)));
...
public static final RegistryObject<Block> LANGSTONE_PILAR = registerBlock("langstone_pilar",
        () -> new RotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE).sound(SoundType.STONE)));
...
public static final RegistryObject<Block> CRACKED_DEEP_LANGSTONE_BRICKS = registerBlock("cracked_deep_langstone_bricks",
        () -> new Block(BlockBehaviour.Properties.copy(Blocks.COBBLED_DEEPSLATE).sound(SoundType.STONE)));
...
public static final RegistryObject<Block> METATORBERNITE_ORE = registerBlock("metatorbernite_ore",
        () -> new MetatorberniteOreBlock(BlockBehaviour.Properties.copy(Blocks.COAL_ORE).sound(SoundType.STONE)));

//Advanced Blocks

public static final RegistryObject<Block> FOSSIL_POLISHER = registerBlock("fossil_polisher",
        () -> new FossilPolishingStationBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).noOcclusion()));
...
public static final RegistryObject<Block> METATORBERNITE_LUCKY_BLOCK = registerBlock("metatorbernite_lucky_block",
        () -> new MetatorberniteLuckyBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).sound(SoundType.AMETHYST)));
...
public static final RegistryObject<Block> POLISHED_DEEP_LANGSTONE_STAIRS = registerBlock("polished_deep_langstone_stairs",
        () -> new StairBlock(() -> ModBlocks.LANGSTONE.get().defaultBlockState(),
                BlockBehaviour.Properties.copy(Blocks.COBBLED_DEEPSLATE)));
public static final RegistryObject<Block> POLISHED_DEEP_LANGSTONE_SLAB = registerBlock("polished_deep_langstone_slab",
        () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.COBBLED_DEEPSLATE)));
public static final RegistryObject<Block> POLISHED_DEEP_LANGSTONE_WALL = registerBlock("polished_deep_langstone_wall",
        () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.COBBLED_DEEPSLATE)));

        //deep_langstone_bricks
public static final RegistryObject<Block> DEEP_LANGSTONE_BRICK_STAIRS = registerBlock("deep_langstone_brick_stairs",
        () -> new StairBlock(() -> ModBlocks.LANGSTONE.get().defaultBlockState(),
                BlockBehaviour.Properties.copy(Blocks.COBBLED_DEEPSLATE)));
...
public static final RegistryObject<Block> CALIPO_SAPLING = BLOCKS.register("calipo_sapling",
        () -> new ModSaplingBlock(new CalipoTreeGrower(), BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING).noOcclusion().noCollission(),ModBlocks.LIVING_LANGSTONE,false));

public static final RegistryObject<Block> CREEPER_SAPLING = BLOCKS.register("creeper_sapling",
        () -> new ModSaplingBlock(new CreeperTreeGrower(), BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING).noOcclusion().noCollission(),ModBlocks.LANGSTONE,true));
...
public static final RegistryObject<Block> CALIPO_SIGN = BLOCKS.register("calipo_sign",
        () -> new ModStandingSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SIGN), ModWoodTypes.CALIPO));

public static final RegistryObject<Block> CALIPO_WALL_SIGN = BLOCKS.register("calipo_wall_sign",
        () -> new ModWallSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WALL_SIGN), ModWoodTypes.CALIPO));

public static final RegistryObject<Block> CALIPO_HANGING_SIGN = BLOCKS.register("calipo_hanging_sign",
        () -> new ModHangingSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_HANGING_SIGN), ModWoodTypes.CALIPO));

public static final RegistryObject<Block> CALIPO_WALL_HANGING_SIGN = BLOCKS.register("calipo_wall_hanging_sign",
        () -> new ModWallHangingSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WALL_HANGING_SIGN), ModWoodTypes.CALIPO));
