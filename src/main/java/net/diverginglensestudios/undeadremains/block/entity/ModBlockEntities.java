...
public class ModBlockEntities {
	public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES = DeferredRegister
			.create(ForgeRegistries.BLOCK_ENTITY_TYPES, UndeadRemains.MOD_ID);

	public static final RegistryObject<BlockEntityType<MetatorberniteEnricherBlockEntity>> METATORBERNITE_ENRICHER = BLOCK_ENTITIES
			.register("metatorbernite_enricher",
					() -> BlockEntityType.Builder.of(MetatorberniteEnricherBlockEntity::new,
							ModBlocks.METATORBERNITE_ENRICHER_CONTROLLER.get())
							.build(null));

	public static final RegistryObject<BlockEntityType<FossilPolishingStationBlockEntity>> FOSSIL_POLISHING_BE = BLOCK_ENTITIES
			.register("fossil_polishing_be",
					() -> BlockEntityType.Builder
							.<FossilPolishingStationBlockEntity>of(FossilPolishingStationBlockEntity::new,
	...
	public static final RegistryObject<BlockEntityType<BubbleBlockBlockEntity>> BUBBLE_BLOCK_BE = BLOCK_ENTITIES
			.register("bubble_block_be",
					() -> BlockEntityType.Builder.<BubbleBlockBlockEntity>of(BubbleBlockBlockEntity::new,
							ModBlocks.BUBBLE_BLOCK.get()).build(null));

	public static final RegistryObject<BlockEntityType<ModSignBlockEntity>> MOD_SIGN = BLOCK_ENTITIES
			.register("mod_sign", () -> BlockEntityType.Builder.<ModSignBlockEntity>of(ModSignBlockEntity::new,
					ModBlocks.ASH_SIGN.get(), ModBlocks.ASH_WALL_SIGN.get(), ModBlocks.CALIPO_SIGN.get(),
					ModBlocks.CALIPO_WALL_SIGN.get()).build(null));
	...
	public static final RegistryObject<BlockEntityType<ModHangingSignBlockEntity>> MOD_HANGING_SIGN = BLOCK_ENTITIES
			.register("mod_hanging_sign",
					() -> BlockEntityType.Builder.<ModHangingSignBlockEntity>of(ModHangingSignBlockEntity::new,
							...
							ModBlocks.CALIPO_HANGING_SIGN.get(), ModBlocks.CALIPO_WALL_HANGING_SIGN.get()).build(null));

	public static final RegistryObject<BlockEntityType<StructureExtenderBlockEntity>> STRUCTURE_EXTENDER_BE = BLOCK_ENTITIES
			.register("structure_extender_be",
