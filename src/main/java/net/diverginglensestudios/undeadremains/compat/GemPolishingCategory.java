...
package net.diverginglensestudios.undeadremains.compat;
...
public class GemPolishingCategory implements IRecipeCategory<GemPolishingRecipe> {
	public static final ResourceLocation UID = new ResourceLocation(UndeadRemains.MOD_ID, "gem_polishing");
	public static final ResourceLocation TEXTURE = new ResourceLocation(UndeadRemains.MOD_ID,
	...
	public GemPolishingCategory(IGuiHelper helper) {
		...
		this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.FOSSIL_POLISHER.get()));
	}
