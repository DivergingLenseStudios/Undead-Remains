...
package net.diverginglensestudios.undeadremains.entity.client.UndeadArcheologist;
...
public class UndeadArcheologistModel<T extends Entity> extends HierarchicalModel<T> {
	...
	this.root().getAllParts().forEach(ModelPart::resetPose);
		...
		this.animate(((UndeadArcheologistEntity) entity).attackAnimationState, ModAnimationDefinitions.UNDEAD_ARCHEOLOGIST_ATTACK, ageInTicks, 1f);
	}
