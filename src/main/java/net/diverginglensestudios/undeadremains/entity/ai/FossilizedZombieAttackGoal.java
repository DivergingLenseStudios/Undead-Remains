...
public class FossilizedZombieAttackGoal extends MeleeAttackGoal {
    private final FossilizedZombieEntity entity;
    private int attackDelay = 10;
    private int ticksUntilNextAttack = 4;
    private boolean shouldCountTillNextAttack = false;

    public FossilizedZombieAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity = ((FossilizedZombieEntity) pMob);
    }
