...
public class TreeZombieAttackGoal extends MeleeAttackGoal {
	private final TreeZombieEntity entity;
	private int attackDelay = 8;
	private int ticksUntilNextAttack = 7;
	private boolean shouldCountTillNextAttack = false;

	public TreeZombieAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
		super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
		entity = ((TreeZombieEntity) pMob);
	}
