...
public class StrayZombieAnimations {
	...
	public static final AnimationDefinition STRAY_ZOMBIE_WALK = AnimationDefinition.Builder.withLength(2.0F).looping()
			...
			.addAnimation("torso", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(17.1901F, 2.1116F, 13.5824F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(2.0F, KeyframeAnimations.degreeVec(17.1901F, 2.1116F, 13.5824F), AnimationChannel.Interpolations.CATMULLROM)
			))
			.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(-15.0F, -1.0F, 5.0F), AnimationChannel.Interpolations.LINEAR)
			))
			...
			.addAnimation("arm_right", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(-95.0F, 12.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.5F, KeyframeAnimations.degreeVec(-103.0F, 12.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(1.0F, KeyframeAnimations.degreeVec(-95.0F, 12.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(1.4583F, KeyframeAnimations.degreeVec(-105.0F, 12.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(2.0F, KeyframeAnimations.degreeVec(-95.0F, 12.5F, 0.0F), AnimationChannel.Interpolations.LINEAR)
			))
			...
			.addAnimation("arm_left", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(2.5F, -12.5F, -10.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.4583F, KeyframeAnimations.degreeVec(12.5F, -12.5F, -10.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(1.0F, KeyframeAnimations.degreeVec(2.5F, -12.5F, -10.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(1.5F, KeyframeAnimations.degreeVec(12.5F, -12.5F, -10.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(2.0F, KeyframeAnimations.degreeVec(2.5F, -12.5F, -10.0F), AnimationChannel.Interpolations.LINEAR)
			))
	...
	public static final AnimationDefinition STRAY_ZOMBIE_ATTACK = AnimationDefinition.Builder.withLength(1.0F)
			.addAnimation("torso", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.2917F, KeyframeAnimations.degreeVec(21.8802F, 23.3989F, 9.0615F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.375F, KeyframeAnimations.degreeVec(9.2912F, 1.2176F, -7.401F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("arm_right", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.4167F, KeyframeAnimations.degreeVec(12.5F, 0.0F, 12.5F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("arm_left", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.4167F, KeyframeAnimations.degreeVec(-100.0F, 0.0F, -12.5F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("arm_left", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(0.4167F, KeyframeAnimations.posVec(0.0F, 0.0F, -1.29F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 2.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
			))
			.build();
