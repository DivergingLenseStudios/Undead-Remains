...
public class BigWoodlingEntity extends ModAbstractZombie {
	public BigWoodlingEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
		super(pEntityType, pLevel);

	}
	private static final EntityDataAccessor<Boolean> ATTACKING =
			SynchedEntityData.defineId(BigWoodlingEntity.class, EntityDataSerializers.BOOLEAN);

	public BigWoodlingEntity(Level pLevel) {
		this(ModEntities.BIG_WOODLING.get(), pLevel);
	}
