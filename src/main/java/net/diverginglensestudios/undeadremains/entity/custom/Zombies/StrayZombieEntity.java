...
import net.diverginglensestudios.undeadremains.entity.ai.FossilizedZombieAttackGoal;
import net.diverginglensestudios.undeadremains.entity.ai.StrayZombieAttackGoal;
