...
Goals:
	...
	-fixes
		...
		fix trapdoor texture
		fix block.tutorialmod.gem_polishing_station in JEI (/src/main/java/net/diverginglensestudios/undeadremains/recipe/GemPolishingRecipe.java)
 */