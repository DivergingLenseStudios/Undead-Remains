...
this.add(ModBlocks.LIVING_LANGSTONE.get(),
        block -> createSingleWithSilkTable(ModBlocks.LIVING_LANGSTONE.get(), ModBlocks.LANGSTONE.get().asItem()));
...
this.add(ModBlocks.METATORBERNITE_ORE.get(),
        block -> createNormalOreDrops(ModBlocks.METATORBERNITE_ORE.get(), ModItems.METATORBERNITE.get(),1,3));
...
this.add(ModBlocks.LANGRITE_ORE.get(),
        block -> createNormalOreDrops(ModBlocks.LANGRITE_ORE.get(), ModItems.RAW_LANGRITE.get(),1 ,3));
...
this.add(ModBlocks.CALIPO_LEAVES.get(), block ->
        createLeavesDrops(block, Blocks.AIR, NORMAL_LEAVES_SAPLING_CHANCES)); // TODO: Change to Sapling!
...
this.add(ModBlocks.CALIPO_SIGN.get(), block ->
        createSingleItemTable(ModItems.CALIPO_SIGN.get()));

this.add(ModBlocks.CALIPO_WALL_SIGN.get(), block ->
        createSingleItemTable(ModItems.CALIPO_SIGN.get()));

this.add(ModBlocks.CALIPO_HANGING_SIGN.get(), block ->
        createSingleItemTable(ModItems.CALIPO_HANGING_SIGN.get()));

this.add(ModBlocks.CALIPO_WALL_HANGING_SIGN.get(), block ->
        createSingleItemTable(ModItems.CALIPO_HANGING_SIGN.get()));
/*//////////Loottables////////// */}
