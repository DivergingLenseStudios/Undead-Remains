...
public class ModBlockTagGenerator extends BlockTagsProvider {
	...
	protected void addTags(HolderLookup.Provider pProvider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE)
				...
				.add(ModBlocks.FOSSIL_PRESSURE_PLATE.get())
				...
				.add(ModBlocks.METATORBERNITE_LUCKY_BLOCK.get())
				.add(ModBlocks.SUPREME_BRICKS.get())
				.add(ModBlocks.SUPREME_PILLAR.get())
				.add(ModBlocks.SUPREME_TILES.get())
				.add(ModBlocks.CHISELED_SUPREME_BRICKS.get())
				...
				.add(ModBlocks.POLISHED_LANGSTONE.get())
				.add(ModBlocks.POLISHED_LANGSTONE_STAIRS.get())
				.add(ModBlocks.POLISHED_LANGSTONE_SLAB.get())
				.add(ModBlocks.LANGSTONE_BRICKS.get())
				.add(ModBlocks.LANGSTONE_BRICK_STAIRS.get())
				.add(ModBlocks.LANGSTONE_BRICK_SLAB.get())
				.add(ModBlocks.CHISELED_LANGSTONE.get())
				.add(ModBlocks.CRACKED_LANGSTONE_BRICKS.get())
				.add(ModBlocks.LANGSTONE_PILLAR.get())
				.add(ModBlocks.DEEP_LANGSTONE_STAIRS.get())
				.add(ModBlocks.DEEP_LANGSTONE_SLAB.get())
				.add(ModBlocks.CRACKED_DEEP_LANGSTONE_BRICKS.get())
				.add(ModBlocks.CHISELED_DEEP_LANGSTONE.get())
				.add(ModBlocks.DEEP_LANGSTONE_BRICKS.get())
				.add(ModBlocks.DEEP_LANGSTONE_BRICK_SLAB.get())
				.add(ModBlocks.DEEP_LANGSTONE_BRICK_STAIRS.get())
				.add(ModBlocks.POLISHED_DEEP_LANGSTONE.get())
				.add(ModBlocks.POLISHED_DEEP_LANGSTONE_SLAB.get())
				.add(ModBlocks.POLISHED_DEEP_LANGSTONE_STAIRS.get())
