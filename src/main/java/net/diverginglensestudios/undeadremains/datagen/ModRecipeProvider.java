...
oreSmelting(pWriter, LANGRITE_SMELTABLES, RecipeCategory.MISC, ModItems.LANGRITE_INGOT.get(), 0.25f, 200, "langrite");
...
oreBlasting(pWriter, LANGRITE_SMELTABLES, RecipeCategory.MISC, ModItems.LANGRITE_INGOT.get(), 0.25f, 100, "langrite");
oreBlasting(pWriter, FOSSIL_BLOCK_SMELTABLES, RecipeCategory.MISC, ModItems.FOSSIL.get(), 2.5f, 1000, "fossil");
//ORE BLASTING//
////////////////////SMELTING////////////////////

////////////////////SMITHING////////////////////
customSmithing(pWriter,/*template*/ModItems.FOSSIL.get(),/*base*/ModItems.FOSSIL_SWORD.get(),/*addition*/Items.AMETHYST_SHARD,
        /*category*/RecipeCategory.COMBAT,/*result*/ModItems.AMETHYST_MODIFIED_FOSSIL_SWORD.get(),/*unlock item*/Items.AMETHYST_SHARD
);
customSmithing(pWriter,/*template*/ModItems.FOSSIL.get(),/*base*/ModItems.FOSSIL_LEGGINGS.get(),/*addition*/Items.SCUTE,
        /*category*/RecipeCategory.COMBAT,/*result*/ModItems.SCUTE_MODIFIED_FOSSIL_LEGGINGS.get(),/*unlock item*/Items.SCUTE
);
////////////////////SMITHING////////////////////

////////////////////STONECUTTING////////////////
//LANGSTONE
stonecutting(Ingredient.of(ModBlocks.SUPREME_BRICKS.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.SUPREME_TILES.get(), 1)
        .unlockedBy(getHasName(ModBlocks.SUPREME_BRICKS.get()), has(ModBlocks.SUPREME_BRICKS.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.SUPREME_BRICKS.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.SUPREME_PILAR.get(), 1)
        .unlockedBy(getHasName(ModBlocks.SUPREME_BRICKS.get()), has(ModBlocks.SUPREME_BRICKS.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.SUPREME_BRICKS.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_SUPREME_BRICKS.get(), 1)
        .unlockedBy(getHasName(ModBlocks.SUPREME_BRICKS.get()), has(ModBlocks.SUPREME_BRICKS.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.LANGSTONE_STAIRS.get(), 1)
        .unlockedBy(getHasName(ModBlocks.LANGSTONE.get()), has(ModBlocks.LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.LANGSTONE_WALL.get(), 1)
        .unlockedBy(getHasName(ModBlocks.LANGSTONE.get()), has(ModBlocks.LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.LANGSTONE_SLAB.get(), 2)
        .unlockedBy(getHasName(ModBlocks.LANGSTONE.get()), has(ModBlocks.LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.FOSSIL_BLOCK.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.FOSSIL_STAIRS.get(), 1)
        .unlockedBy(getHasName(ModBlocks.FOSSIL_BLOCK.get()), has(ModBlocks.FOSSIL_BLOCK.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.FOSSIL_BLOCK.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.FOSSIL_WALL.get(), 1)
        .unlockedBy(getHasName(ModBlocks.FOSSIL_BLOCK.get()), has(ModBlocks.FOSSIL_BLOCK.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.FOSSIL_BLOCK.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.FOSSIL_SLAB.get(), 2)
        .unlockedBy(getHasName(ModBlocks.FOSSIL_BLOCK.get()), has(ModBlocks.FOSSIL_BLOCK.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.LANGSTONE_BRICKS.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.LANGSTONE_BRICK_STAIRS.get(), 1)
        .unlockedBy(getHasName(ModBlocks.LANGSTONE_BRICKS.get()), has(ModBlocks.LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.LANGSTONE_BRICKS.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.LANGSTONE_BRICK_WALL.get(), 1)
        .unlockedBy(getHasName(ModBlocks.LANGSTONE_BRICKS.get()), has(ModBlocks.LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.LANGSTONE_BRICKS.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.LANGSTONE_BRICK_SLAB.get(), 2)
        .unlockedBy(getHasName(ModBlocks.LANGSTONE_BRICKS.get()), has(ModBlocks.LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.POLISHED_LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_LANGSTONE_STAIRS.get(), 1)
        .unlockedBy(getHasName(ModBlocks.POLISHED_LANGSTONE.get()), has(ModBlocks.LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.POLISHED_LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_LANGSTONE_WALL.get(), 1)
        .unlockedBy(getHasName(ModBlocks.POLISHED_LANGSTONE.get()), has(ModBlocks.LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.POLISHED_LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_LANGSTONE_SLAB.get(), 2)
        .unlockedBy(getHasName(ModBlocks.POLISHED_LANGSTONE.get()), has(ModBlocks.LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.LANGSTONE_PILAR.get(), 1)
        .unlockedBy(getHasName(ModBlocks.LANGSTONE.get()), has(ModBlocks.LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_LANGSTONE.get(), 1)
        .unlockedBy(getHasName(ModBlocks.LANGSTONE.get()), has(ModBlocks.LANGSTONE.get()))
        .save(pWriter);
//DEEP LANGSTONE
stonecutting(Ingredient.of(ModBlocks.DEEP_LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.DEEP_LANGSTONE_STAIRS.get(), 1)
        .unlockedBy(getHasName(ModBlocks.DEEP_LANGSTONE.get()), has(ModBlocks.DEEP_LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.DEEP_LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.DEEP_LANGSTONE_WALL.get(), 1)
        .unlockedBy(getHasName(ModBlocks.DEEP_LANGSTONE.get()), has(ModBlocks.DEEP_LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.DEEP_LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.DEEP_LANGSTONE_SLAB.get(), 2)
        .unlockedBy(getHasName(ModBlocks.DEEP_LANGSTONE.get()), has(ModBlocks.DEEP_LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.DEEP_LANGSTONE_BRICKS.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.DEEP_LANGSTONE_BRICK_STAIRS.get(), 1)
        .unlockedBy(getHasName(ModBlocks.DEEP_LANGSTONE_BRICKS.get()), has(ModBlocks.DEEP_LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.DEEP_LANGSTONE_BRICKS.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.DEEP_LANGSTONE_BRICK_WALL.get(), 1)
        .unlockedBy(getHasName(ModBlocks.DEEP_LANGSTONE_BRICKS.get()), has(ModBlocks.DEEP_LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.DEEP_LANGSTONE_BRICKS.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.DEEP_LANGSTONE_BRICK_SLAB.get(), 2)
        .unlockedBy(getHasName(ModBlocks.DEEP_LANGSTONE_BRICKS.get()), has(ModBlocks.DEEP_LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.POLISHED_DEEP_LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_DEEP_LANGSTONE_STAIRS.get(), 1)
        .unlockedBy(getHasName(ModBlocks.POLISHED_DEEP_LANGSTONE.get()), has(ModBlocks.DEEP_LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.POLISHED_DEEP_LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_DEEP_LANGSTONE_WALL.get(), 1)
        .unlockedBy(getHasName(ModBlocks.POLISHED_DEEP_LANGSTONE.get()), has(ModBlocks.DEEP_LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.POLISHED_DEEP_LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_DEEP_LANGSTONE_SLAB.get(), 2)
        .unlockedBy(getHasName(ModBlocks.POLISHED_DEEP_LANGSTONE.get()), has(ModBlocks.DEEP_LANGSTONE.get()))
        .save(pWriter);
stonecutting(Ingredient.of(ModBlocks.DEEP_LANGSTONE.get())
        ,RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_DEEP_LANGSTONE.get(), 1)
        .unlockedBy(getHasName(ModBlocks.DEEP_LANGSTONE.get()), has(ModBlocks.DEEP_LANGSTONE.get()))
        .save(pWriter);
////////////////////STONECUTTING////////////////
...
ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.ASH_SIGN.get())
        ...
        .pattern("WWW")
        .pattern(" S ")
        .define('S', Ingredient.of(ItemTags.create(new ResourceLocation("forge", "rods/wooden")))) 
...
ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.CALIPO_HANGING_SIGN.get())
        ...
        .define('W', ModBlocks.CALIPO_PLANKS.get()) 
        .unlockedBy(getHasName(ModBlocks.CALIPO_HANGING_SIGN.get()), has(ModBlocks.CALIPO_HANGING_SIGN.get())) 
        .save(pWriter);
...
ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.ASH_HANGING_SIGN.get())
        ...
        .define('C', Items.CHAIN) 
        .define('W', ModBlocks.ASH_PLANKS.get()) 
        .unlockedBy(getHasName(ModBlocks.ASH_HANGING_SIGN.get()), has(ModBlocks.ASH_HANGING_SIGN.get())) 
        .save(pWriter);
//BLOCKS//
...
ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.LANGRITE_HELMET.get())
        ...
        .unlockedBy(getHasName(ModItems.LANGRITE_INGOT.get()),has(ModItems.LANGRITE_INGOT.get())) 
        .save(pWriter);
...
ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.METATORBERNITE_HELMET.get())
        ...
        .pattern("S S")
        .pattern("   ")
        .define('S', Ingredient.of(ItemTags.create(new ResourceLocation("forge", "metatorbernite")))) 
        .unlockedBy(getHasName(ModItems.METATORBERNITE.get()), has(ItemTags.create(new ResourceLocation("forge", "metatorbernite")))) 
        .save(pWriter);
...
ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SPIKE_BAT.get())
        ...
        .define('A', Items.STICK)
        .unlockedBy(getHasName(ModItems.SPIKE.get()), has(ItemTags.create(new ResourceLocation("forge", "spike")))) 
        .unlockedBy(getHasName(Items.STICK), has(Items.STICK))
        .save(pWriter);
//TOOLS//
...
ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FOSSIL_POLISHER.get())
        ...
        .pattern("QYA")
        .pattern("DDD")
        .define('A', Ingredient.of(ItemTags.create(new ResourceLocation("minecraft", "planks"))))
...
ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.CALIPO_FENCE.get(),3)
        ...
        .define('A', Items.STICK)
        .unlockedBy(getHasName(ModBlocks.CALIPO_PLANKS.get()), has(ModBlocks.CALIPO_PLANKS.get()))
...
////////////////////SHAPELESS////////////////////
//SHAPELESS ITEM//
ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.METATORBERNITE_GRENADE.get(), 4)//resulting items
...
ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModBlocks.CALIPO_BUTTON.get(), 1)//resulting items
        .requires(ModBlocks.CALIPO_PLANKS.get())//required items
        .unlockedBy(getHasName(ModBlocks.CALIPO_PLANKS.get()), has(ModBlocks.CALIPO_PLANKS.get()))
        .save(pWriter);

ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.ASH_CHEST_BOAT.get(), 1)//resulting items
...
ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.METATORBERNITE.get(), 9)
        ...
        .unlockedBy(getHasName(ModBlocks.METATORBERNITE_BLOCK.get()), has(ModBlocks.METATORBERNITE_BLOCK.get()))
...
ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModBlocks.RAW_FOSSIL_BLOCK.get(), 1)
        ...
        .unlockedBy(getHasName(ModItems.RAW_DEEPSLATE_FOSSIL.get()), has(ModItems.RAW_DEEPSLATE_FOSSIL.get()))
...
public static SingleItemRecipeBuilder stonecutting(Ingredient pIngredient, RecipeCategory pCategory, ItemLike pResult, int count) {
        return new SingleItemRecipeBuilder(pCategory, RecipeSerializer.STONECUTTER, pIngredient, pResult, count);
}
protected static void customSmithing(Consumer<FinishedRecipe> finishedRecipeConsumer,Item template,Item base,Item addition,RecipeCategory category,Item result,Item unlockItem) {
...
protected static void oreCooking(Consumer<FinishedRecipe> pFinishedRecipeConsumer, RecipeSerializer<? extends AbstractCookingRecipe> pCookingSerializer, List<ItemLike> pIngredients, RecipeCategory pCategory, ItemLike pResult, float pExperience, int pCookingTime, String pGroup, String pRecipeName) {
        ...
        SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), pCategory, pResult,
                ...
                .save(pFinishedRecipeConsumer,  UndeadRemains.MOD_ID + ":" + getItemName(pResult) + pRecipeName + "_" + getItemName(itemlike));
                }
        }       
}
